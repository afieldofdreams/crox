...
.chat{position:absolute;top:0;bottom:71px;left:0;right:0;
...
.bottom{position:absolute;bottom:0;left:0;right:0;z-index:2;height:71px;
        background:${C.bar};backdrop-filter:blur(20px);
...
.field{flex:1;height:35px;background:#fff;border:0.5px solid ${C.hairline};
       ...
       justify-content:flex-end;padding:0 9px}
...
<div class="bottom">
  <div class="composer">
    ${ICONS.plus}
    <div class="field">${ICONS.sticker}</div>
    ${ICONS.camera}
    ${ICONS.mic}
  </div>
