...
export const AiLegalPost: React.FC = () => {
  return (
    <div className="space-y-6">
      ...
      <p className="text-[0.95rem] text-fg-dim leading-[1.8]">
        <Link to="/ai-integration" className="text-fg border-b border-border pb-px hover:border-accent transition-colors">
          Discuss AI integration for your practice
        </Link>
        {' '}with compliance considerations in mind. We'll help you identify the right workflows, design the governance framework, and implement the MCP connections safely and in ways that strengthen your compliance position.
      </p>
    </div>
  );
};
