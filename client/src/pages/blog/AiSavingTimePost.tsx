...
export const AiSavingTimePost: React.FC = () => {
  return (
    <div className="space-y-6">
      ...
      <p className="text-[0.95rem] text-fg-dim leading-[1.8]">
        <Link to="/ai-integration" className="text-fg border-b border-border pb-px hover:border-accent transition-colors">
          Talk to our team about where you could save time
        </Link>
        {' '}with AI integration. We'll audit your workflows, identify your biggest opportunities, and show you exactly what's possible without building anything custom.
      </p>
    </div>
  );
};
